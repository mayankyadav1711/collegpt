        ...
        <div className="card-main">
          ...
          >
            <div className="card-content">
              ...
              👋Hello! I'm Divya Kaurani, a proficient MERN Stack Developer well-versed in DSA (C, C++, Java) and Cloud Computing. Passionate about creating tech wonders. Let's innovate together!
              </p>
            </div>
            <div class="card-social">
            <ul>
            <li>
              <Link to="https://github.com/KauraniDivya" target="_blank" rel="noreferrer">
                <svg
              ...
              <li>
              <Link to="https://www.linkedin.com/in/divyakaurani/"
              ...
              <li>
              <Link to="https://leetcode.com/kauranidivya/" target="_blank">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="16"
                  height="16"
              ...
              <li>
              <Link to="https://drive.google.com/file/d/1IyHRcgUehEnuozvfQ4gs0np59O05wnSN/view?usp=sharing" target="_blank">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="16"
                  height="16"
              ...
              <li>
              <Link to="https://instagram.com/divya_kaurani20/"
                target="_blank" rel="noreferrer"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
              ...
              <li>
              <Link to="https://twitter.com/d_kaurani61801"
                target="_blank" rel="noreferrer"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
          ...
          >
            <div className="card-content">
              ...
              <div class="card-timeline-divya">
                ...
                <div class="card-item" data-year="2023">
                  <div class="card-item-title">
                    Participant of the <span>NPTEL Courses</span>
                  </div>
                  <div class="card-item-desc">
            ...
            <div class="card-content">
              ...
              <div class="card-contact-wrapper">
                <div class="card-contact">
                  ...
                  Ahmedabad, Gujarat, Bharat-382330.
                </div>
                ...
                <Link to="mailto:kauranidivya@gmail.com"> <button class="contact-me">WORK TOGETHER</button></Link>
              </div>
            </div>
          </div>
        </div>
