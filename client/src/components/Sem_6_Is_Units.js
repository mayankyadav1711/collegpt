...
import postpic from "./images/Thumbnail/Sem-6/is.png";
      ...
      <section class="playlist-details">
        ...
        <div class="row">
          ...
          <div class="column">
            ...
            <div class="details">
              <h3>Information Security [IT602-N]</h3>
              <p>
...
<Link to="/watchvideo/686" class="box">
  <a>
    {/* <i class="fas fa-play"></i> */}
    <img src={postpic} alt="" />
    <h3>Symmetric and Asymmetric Cryptographic Techniques</h3>
  </a>
</Link>
...
<Link to="/watchvideo/687" class="box">
  <a>
    {/* <i class="fas fa-play"></i> */}
    <img src={postpic} alt="" />
    <h3>Authentication Techniques</h3>
  </a>
</Link>
