...
// import thumb from "./images/Thumbnail/Sem-5/MAP.webp"
import postpic from "./images/Thumbnail/Sem-5/MAP.webp"
...
<section class="playlist-details">
    ...
    <div class="row">
        ...
        <div class="column">
            ...
            <div class="details">
                <h3 className="mt-5">Microprocessor Architecture and Programming [CE502-N]</h3>
...
<section class="playlist-videos">
  ...
  <Link to='/watchvideo/571' class="box">  
    <a>
      ...
      <img src={postpic} alt=""/>
      <h3 className="mt-5">Introduction of 8085/80x86/8088</h3>
    </a> 
  </Link>
  ...
  <Link to='/watchvideo/572' class="box">  
    <a>
      {/* <i class="fas fa-play"></i> */}
      <img src={postpic} alt=""/>
      <h3 className="mt-5">Programming of 8085/8086</h3>
    </a> 
  </Link>
  ...
  <Link to='/watchvideo/573' class="box">  
    <a>
      {/* <i class="fas fa-play"></i> */}
      <img src={postpic} alt=""/>
      <h3 className="mt-5">Interrupts and Interrupt processing</h3>
    </a> 
  </Link>
  ...
  <Link to='/watchvideo/575' class="box">  
    <a>
      {/* <i class="fas fa-play"></i> */}
      <img src={postpic} alt=""/>
      <h3 className="mt-5">Interfacing peripherals and applications</h3>
    </a> 
  </Link>
  ...
  <Link to='/watchvideo/576' class="box">  
    <a>
      {/* <i class="fas fa-play"></i> */}
      <img src={postpic} alt=""/>
      <h3 className="mt-5">Intel microprocessors</h3>
    </a> 
  </Link>
  ...
  <Link to='/watchvideo/577' class="box">  
    <a>
      {/* <i class="fas fa-play"></i> */}
      <img src={postpic} alt=""/>
      <h3 className="mt-5">ARM Processor</h3>
    </a> 
  </Link>
</div>
