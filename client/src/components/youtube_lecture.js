...
const Youtube_Lecture = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await fetch(
                "https://api-collegpt.vercel.app/doubt",
                {
                    method: "POST",
                    headers: {
            ...
            {youtube ? (
                ...
                <p className="date">
                  ...
                  <span>{uploadTimestamp}</span>
                            ...
                            <Link
                                to="https://www.youtube.com/@ColleGPT"
                                target="blank">
                                <div className="tutor">
                                    <img
                                        src="https://yt3.ggpht.com/3zPQXWu3swZ9FbRjspX0A3pIYq2zYZNGc65Qv7fTqOfI-eMuA1V31dDMGT6Vxf9NwcXvszp7=s48-c-k-c0x00ffffff-no-rj"
                                        className="mt-4"
                                        alt=""
                                    />

                                    <div className="flex items-start">
                                        <h3 className="font-semibold  absolute ">
                                            ColleGPT
                                        </h3>
                                        ...
                                        <span className="text-gray-900 dark:text-white font-semibold -mb-20 ">
                                            <FaEye />
                                            
                                        </span>
                                        <span className="text-gray-900 dark:text-white font-semibold -ml-5 -mb-20 ">
                                            {views}
