...
const Homepage = () => {
    ...
    <section class="flex items-center justify-center text-center h-full">
        <div class="py-14 px-4 mx-auto max-w-screen-xl text-center lg:py-52 lg:px-12 mb-16">
            <a href="#"  onClick={scrollToNextSection} class="inline-flex justify-between items-center py-1 px-1 mb-12 text-xl lg:text-sm text-gray-700 bg-gray-100 rounded-full dark:bg-gray-800 dark:text-white hover:bg-gray-200 dark:hover:bg-gray-700" role="alert">
