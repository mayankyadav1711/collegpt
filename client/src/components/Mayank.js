    ...
    <div className="chakrabody">
      ...
      >
        <div className="card-header">
          <div className="card-cover-mayank"></div>
          <img
        ...
        <div className="card-main">
          ...
          >
            ...
            <ul>
            <li>
              <a href="https://github.com/mayankyadav1711" target="_blank" rel="noreferrer">
                <svg
              ...
              <li>
              <a href="https://leetcode.com/mayankyadav_17/" target="_blank" rel="noreferrer">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="16"
                  height="16"
              ...
              <li>
              <a href="https://drive.google.com/file/d/1yaIBkjaDAiMNdi63Pi_Lerl7PktDAlPZ/view?usp=sharing" target="_blank" rel="noreferrer">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="16"
                  height="16"
              ...
              <li>
              <a
                href="https://instagram.com/___mayank17___"
                target="_blank" rel="noreferrer"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
