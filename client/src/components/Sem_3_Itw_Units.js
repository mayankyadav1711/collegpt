...
// import thumb from "./images/Thumbnail/Sem-3/ITW.webp"
import postpic from "./images/Thumbnail/Sem-3/ITW.webp"
...
<section class="playlist-details">
    ...
    <div class="row">
        ...
        <div class="column">
            ...
            <div class="details">
                <h3 className="mt-5">IT Workshop [CT305-N]</h3>
...
<section class="playlist-videos">
  ...
  <Link to='/watchvideo/351' class="box">  
    <a>
      ...
      <img src={postpic} alt=""/>
      <h3 className="mt-5">Introduction to WWW</h3>
    </a> 
  </Link>
  ...
  <Link to='/watchvideo/352' class="box">  
    <a>
      {/* <i class="fas fa-play"></i> */}
      <img src={postpic} alt=""/>
      <h3 className="mt-5">Introduction to HTML</h3>
    </a> 
  </Link>
  ...
  <Link to='/watchvideo/355' class="box">  
    <a>
      {/* <i class="fas fa-play"></i> */}
      <img src={postpic} alt=""/>
      <h3 className="mt-5">XML and Ajax</h3>
    </a> 
  </Link>
