      ...
      <footer class="footer-section flex flex-col items-center">
        <div class="container mx-auto lg:flex justify-center">
          <div class="grid grid-cols-1 lg:grid-cols-3 gap-10 lg:gap-40">
            ...
            <div class="flex flex-col items-center -mt-5 lg:items-start space-y-5">
              {" "}
              {/* <h3 className="text-3xl font-bold  text-gray-900 dark:text-white">ColleGPT</h3> */}
              <Link to="/">
                <div className=" text-gray-900 dark:text-white">
                  <span className="flex items-center font-bold lg:text-[4rem] text-[6rem]">
                    <span>C</span>
                    <img
                      src={logo}
            ...
            <div class="flex flex-col items-center space-y-5 sm:space-y-0 space-x-2 lg:space-x-2">
              <div className="mb-4">
                <form onSubmit={handlesubscribe}>
                  ...
                  />
                  <button
                    className="lg:px-4 px-8 lg:py-2 py-2 bg-[#12b8ff] text-white rounded-lg ml-2 lg:text-2xl text-4xl"
                    type="submit"
                  >
                    Subscribe
                  </button>
