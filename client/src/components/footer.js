...
<path fill="#00000" fill-rule="evenodd" d="M38,42H10c-2.209,0-4-1.791-4-4V10c0-2.209,1.791-4,4-4h28	c2.209,0,4,1.791,4,4v28C42,40.209,40.209,42,38,42z" clip-rule="evenodd"></path><path fill="#fff" d="M34.257,34h-6.437L13.829,14h6.437L34.257,34z M28.587,32.304h2.563L19.499,15.696h-2.563 L28.587,32.304z"></path><polygon fill="#fff" points="15.866,34 23.069,25.656 22.127,24.407 13.823,34"></polygon><polygon fill="#fff" points="24.45,21.721 25.355,23.01 33.136,14 31.136,14"></polygon>
</svg>
                                        <span class="sr-only">
                                            Twitter page
                                        </span>
                            ...
                            <a href="https://www.linkedin.com/in/collegpt/" className="ml-4 hover:text-gray-400">
                                LinkedIN
                            </a>
                            <a href="https://twitter.com/ColleGPT" className="ml-4 hover:text-gray-400">
                                Twitter
                            </a>
                            <a href="https://www.instagram.com/collegpt?igsh=aXFjNTQzemI3eGVx" className="ml-4 hover:text-gray-400">
                                Instagram
                            </a>
                            <a href="https://chat.whatsapp.com/KKbEWaxNaxt1OI9EVtJxm9" className="ml-4 hover:text-gray-400">
                                Whatsapp
                            </a>
                        </div>
                    </div>
                ...
                <div class="row bg-[#c0e8eb] dark:bg-[#151e3689]">
                            <div class="col-xl-6 col-lg-6 text-center text-lg-left">
                                <div class="copyright-text">
                                    <p>
                                        ...
                                        Reserved <a
                                        href="www.collegpt.com">ColleGPT</a>
                                    </p>
                                </div>
                            </div>
                            {/* <div class="col-xl-6 col-lg-6">
                                <div class="flex justify-center mt-4 sm:justify-center sm:mt-0">
                                    ...
                                    <a
                                        href="#"
                                        class="text-green-600 hover:text-green-800 dark:hover:text-white ms-5">
                                        <svg
                                            xmlns="http://www.w3.org/2000/svg"
                                            x="0px"
                                            y="0px"
                        ...
                        <div class="row">
                            <div class="col-xl-6 col-lg-6 text-center text-lg-left">
                                <div class="copyright-text">
                                    <p>
                                        Copyright &copy; 2024, All Right
                                        Reserved <Link to="#">ColleGPT</Link>
                                    </p>
                                </div>
                            </div>
                            <div class="col-xl-6 col-lg-6">
