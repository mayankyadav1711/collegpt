    ...
    <>
        ...
        <div class="profile-card">
            ...
            <div class="caption">
                ...
                <div class="social-links">
                    <Link to="https://www.linkedin.com/in/mayankyadav17/" target="_blank"><i class="fab fa-linkedin"></i></Link>
                    <Link to="https://instagram.com/___mayank17___" target="_blank"><i class="fab fa-instagram"></i></Link>
                    <Link to="https://twitter.com/mayankyadav_17" target="_blank" rel="noreferrer">
                              <svg
        ...
        <div class="footer-img">
            ...
            <div class="caption">
                ...
                <div class="social-links">
                    <Link to="https://www.linkedin.com/in/divyakaurani/" target="_blank"><i class="fab fa-linkedin"></i></Link>
                    <Link to="https://instagram.com/divya_kaurani20/" target="_blank"><i class="fab fa-instagram"></i></Link>
                    <Link to="https://twitter.com/d_kaurani61801" target="_blank" rel="noreferrer"><svg
                            xmlns="http://www.w3.org/2000/svg"
                            width=".2in"
                            height=".2in"
                            viewBox="0 0 1280 1280"
        ...
        <div class="footer-img">
            ...
            <div class="caption">
                ...
                <div class="social-links">
                    <Link to="https://www.linkedin.com/in/darshit-sojitra/" target="_blank"><i class="fab fa-linkedin"></i></Link>
                    <Link to="https://www.instagram.com/darshit_sojitraa/" target="_blank"><i class="fab fa-instagram"></i></Link>
                    <Link to="https://twitter.com/DarshitSojitraa?t=B7p7nOVhyLYfc-rmTeWx_g&s=09" target="_blank" rel="noreferrer"><svg
                            xmlns="http://www.w3.org/2000/svg"
                            width=".2in"
                            height=".2in"
                            viewBox="0 0 1280 1280"
