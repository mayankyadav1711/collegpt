    ...
    <span key={index}>
      ...
      {index < userProfile.Roles.length - 1 && <span className="bullet"> • </span>}
                        ...
                        <div className="icons">
                          <ul>
                            <li>
                              <Link to={userProfile.githubURL} target="_blank" rel="noreferrer">
                              <svg
                          ...
                          >
                            ...
                            <li>
                              <Link to={userProfile.linkedinURL} target="_blank" rel="noreferrer">
                              <svg
                            viewBox="-2 0 27 27"
                            fill="currentColor"
                            xmlns="http://www.w3.org/2000/svg"
                          >
                            ...
                            <li>
                              <Link to={userProfile.codingURL}>
                                <Link to={userProfile.codingURL} target="_blank" rel="noreferrer">
                                <svg
                            xmlns="http://www.w3.org/2000/svg"
                            width="16"
                            height="16"
                          ...
                          >
                            ...
                            <li>
                              <Link to={userProfile.resumeURL} target="_blank" rel="noreferrer">
                              <svg
                            xmlns="http://www.w3.org/2000/svg"
                            width="16"
                            height="16"
                          ...
                          >
                            ...
                            <li>
                              <Link to={userProfile?.instaURL} target="_blank" rel="noreferrer">
                              <svg
                            xmlns="http://www.w3.org/2000/svg"
                            fill="currentColor"
                          ...
                          >
                            ...
                            <li>
                              <Link to={userProfile.twitterURL} target="_blank" rel="noreferrer">
                              <svg
                            xmlns="http://www.w3.org/2000/svg"
                            width="17.7778in"
                            height="17.7778in"
