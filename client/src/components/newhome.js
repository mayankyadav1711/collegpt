    ...
    <>
      ...
      <div className="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
        <div className="my-8 max-w-screen-md lg:my-16">
          <h2 className="mb-4 text-4xl font-extrabold text-gray-900 dark:text-white">Welcome to ColleGPT 🚀</h2>
          <p className="text-gray-500 sm:text-xl dark:text-gray-400">Your ultimate College Companion is here to revolutionize your academic journey. Break down the boundaries of traditional education with our innovative features!</p>
        </div>
