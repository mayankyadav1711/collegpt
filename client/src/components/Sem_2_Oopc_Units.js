...
<section class="playlist-details">
   ...
   <div class="row">
      ...
      <div class="column">
         ...
         <div class="details">
            <h3 className="mt-5">Object Oriented Programming Using 'C++' [CC111-N]</h3>
...
<Link to='/watchvideo/211' class="box">
   <a>
      ...
      <h3 className="mt-5">Elaborated understanding of Essentials C Programming</h3>
   </a>
</Link>
...
<Link to='/watchvideo/212' class="box">
   <a>
      {/* <i class="fas fa-play"></i> */}
      <img src={postpic} alt=""/>
      <h3 className="mt-5">Fundamental Concepts of OOP with C++</h3>
   </a>
</Link>
...
<Link to='/watchvideo/213' class="box">
   <a>
      {/* <i class="fas fa-play"></i> */}
      <img src={postpic} alt=""/>
      <h3 className="mt-5">C++ Programming Syntactical Basics</h3>
   </a>
</Link>
...
<Link to='/watchvideo/214' class="box">
   <a>
      {/* <i class="fas fa-play"></i> */}
      <img src={postpic} alt=""/>
      <h3 className="mt-5">C++ Functions</h3>
   </a>
</Link>
...
<Link to='/watchvideo/215' class="box">
   <a>
      {/* <i class="fas fa-play"></i> */}
      <img src={postpic} alt=""/>
      <h3 className="mt-5">Objects and Class</h3>
   </a>
</Link>
...
<Link to='/watchvideo/216' class="box">
   <a>
      {/* <i class="fas fa-play"></i> */}
      <img src={postpic} alt=""/>
      <h3 className="mt-5">Operator Overloading</h3>
   </a>
</Link>
...
<Link to='/watchvideo/217' class="box">
   <a>
      {/* <i class="fas fa-play"></i> */}
      <img src={postpic} alt=""/>
      <h3 className="mt-5">Inheritance</h3>
   </a>
</Link>
...
<Link to='/watchvideo/218' class="box">
   <a>
      {/* <i class="fas fa-play"></i> */}
      <img src={postpic} alt=""/>
      <h3 className="mt-5">Polymorphism & Virtual Functions</h3>
   </a>
</Link>
...
<Link to='/watchvideo/219' class="box">
   <a>
      {/* <i class="fas fa-play"></i> */}
      <img src={postpic} alt=""/>
      <h3 className="mt-5">Templates and Exception Handling</h3>
   </a>
</Link>
...
<Link to='/watchvideo/2110' class="box">
   <a>
      {/* <i class="fas fa-play"></i> */}
      <img src={postpic} alt=""/>
      <h3 className="mt-5">Introduction to Streams and Files</h3>
   </a>
</Link>
